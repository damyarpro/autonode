...
export default function AiCoach() {
  ...
  return (
    <AppShell flush>
      ...
      {showPrompts && (
        <div className="border-t border-hairline bg-panel/70 px-4 py-3">
      ...
      <div className="border-t border-hairline bg-panel/70 px-4 pb-3 pt-3">
        <div className="mx-auto max-w-2xl">
          ...
          <button
            ...
            className="mt-2 w-full rounded-xl border border-hairline py-2 text-[11.5px] text-white/55 transition hover:text-white"
          >
            {t(COPY.ready)}
          </button>
        </div>
